...
from utils.SAM.utils.register import Registry
...
def build_base_optimizer(args, parameters):
    ...
    if len(args_opt) == 1:
        ...
        raise ValueError("Wrong opt param!")
    ...
    if base_opt == 'sgd':
        ...
        opt_kwargs.pop("nesterov")
        base_optimizer = optim.AdamW(params=parameters, **opt_kwargs)
    elif base_opt =="adam":
        base_optimizer = optim.Adam(parameters, lr=args.lr, weight_decay=0.00001, )
    else:
